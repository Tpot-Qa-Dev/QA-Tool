...
export const TOOL_DEFINITIONS = [
  {
    ...
    description: 'Capture a real screenshot of a webpage using Playwright Chromium browser',
    input_schema: urlInput,
  },
  {
    name: 'playwright_console_errors',
    description: 'Capture all real JavaScript console errors and failed network requests on a page',
    input_schema: urlInput,
  },
  {
    name: 'playwright_check_links',
    description: 'Check all links on a page and detect broken ones (404, errors)',
    input_schema: urlInput,
  },
  {
    name: 'playwright_audit_forms',
    description: 'Audit all forms on a page: fields, labels, validation, method, accessibility',
    input_schema: urlInput,
  },
  {
    name: 'playwright_web_vitals',
    description: 'Measure real Core Web Vitals (LCP, FCP, TTFB) in a real browser',
    input_schema: urlInput,
  },
  {
    name: 'playwright_tracking',
    description: 'Detect analytics scripts (GA4, GTM, FB Pixel, Hotjar, Clarity) on a page',
    input_schema: urlInput,
  },
  {
    name: 'playwright_accessibility',
    description: 'Run accessibility checks: missing alt text, unlabelled inputs, H1 structure',
    input_schema: urlInput,
  },
  {
    name: 'playwright_meta_audit',
    description: 'Extract all page metadata: title, OG tags, canonical, headings, schema',
    input_schema: urlInput,
  },
  {
    name: 'playwright_detect_environment',
    description:
      'Detect whether the URL is a live production site or still in development/staging/maintenance (noindex, staging hostnames, placeholder content, "coming soon", visible errors)',
    input_schema: urlInput,
  },
  {
    name: 'pagespeed_audit',
    description: 'Call Google PageSpeed Insights API for Lighthouse scores and CWV benchmarks',
    input_schema: urlInput,
  },
  {
    name: 'figma_fetch',

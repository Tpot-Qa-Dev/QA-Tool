...
function normalize(raw = {}) {
  ...
  const audit = {
    ...
    extraInstructions: typeof a.extraInstructions === 'string' ? a.extraInstructions.slice(0, 2000) : DEFAULTS.audit.extraInstructions,
    defaultModule:     typeof a.defaultModule === 'string' ? a.defaultModule.slice(0, 60) : DEFAULTS.audit.defaultModule,
  ...
  const u = raw.ui || {}
  const ui = {
    accent:       typeof u.accent === 'string'  && (u.accent === '' || HEX.test(u.accent))   ? u.accent  : DEFAULTS.ui.accent,
    accent2:      typeof u.accent2 === 'string' && (u.accent2 === '' || HEX.test(u.accent2)) ? u.accent2 : DEFAULTS.ui.accent2,
...
function applyRuntime(settings) {
  ...
  config.playwright.viewport     = { width: settings.browser.viewportWidth, height: settings.browser.viewportHeight }

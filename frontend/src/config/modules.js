...
const C = { cyan: '#00E5FF', green: '#00FF94', orange: '#FF9F43', red: '#FF4560', purple: '#A78BFA' }
    ...
    checkboxGroups: [
      {
        group: 'Visual Checks',
        items: [
          { id: 'typography',   label: 'Typography (font, size, weight, spacing)', default: true,  tools: [T.shot, T.figma] },
          { id: 'colors',       label: 'Colors & Background (hex match)',           default: true,  tools: [T.shot, T.figma] },
          { id: 'spacing',      label: 'Padding & Margin spacing',                  default: true,  tools: [T.shot, T.figma] },
          { id: 'layout',       label: 'Layout & Grid alignment',                   default: true,  tools: [T.shot, T.figma] },
          { id: 'pixel_check',  label: 'Pixel-by-pixel image diff',                 default: false, tools: [T.shot, T.figma] },
          { id: 'images',       label: 'Images & Icons (size, quality)',            default: true,  tools: [T.shot, T.figma] },
          { id: 'shadows',      label: 'Shadows & Borders',                         default: false, tools: [T.shot, T.figma] },
          { id: 'border_radius',label: 'Border radius & corner styling',            default: false, tools: [T.shot, T.figma] },
          { id: 'opacity',      label: 'Opacity & transparency',                    default: false, tools: [T.shot, T.figma] },
      ...
      },
      {
        ...
        items: [
          { id: 'cta_buttons', label: 'CTA Buttons (style, size)',     default: true,  tools: [T.shot, T.figma] },
          { id: 'forms',       label: 'Form elements (inputs, labels)', default: true,  tools: [T.shot, T.forms] },
          { id: 'navigation',  label: 'Navigation & Header',           default: true,  tools: [T.shot, T.figma] },
    ...
    checkboxGroups: [
      {
        ...
        items: [
          { id: 'all_links',      label: 'All links (href, target, status)', default: true,  tools: [T.links] },
          { id: 'broken_links',   label: 'Broken links (404 check)',          default: true,  tools: [T.links] },
          { id: 'external_links', label: 'External links (target, rel)',      default: false, tools: [T.links] },
          { id: 'buttons',        label: 'Buttons & CTAs (labels, events)',   default: true,  tools: [T.a11y] },
          { id: 'forms_tracking', label: 'Forms (fields, actions, method)',   default: true,  tools: [T.forms] },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'custom_events', label: 'Custom dataLayer events',           default: false, tools: [T.tracking] },
          { id: 'heatmap',       label: 'Heatmap triggers (Hotjar/Clarity)', default: false, tools: [T.tracking] },
          { id: 'linkedin_tiktok', label: 'LinkedIn / TikTok pixels',        default: false, tools: [T.tracking] },
        ],
      },
    ],
  },
  {
    ...
    checkboxGroups: [
      ...
      },
      {
        ...
        items: [
          { id: 'required_fields',  label: 'Required field validation',     default: true,  tools: [T.forms] },
          { id: 'email_validation', label: 'Email format validation',       default: true,  tools: [T.forms] },
          { id: 'phone_validation', label: 'Phone number validation',       default: false, tools: [T.forms] },
          { id: 'field_labels',     label: 'Field labels & placeholders',   default: false, tools: [T.forms, T.a11y] },
          { id: 'success_message',  label: 'Success / Thank-you message',   default: true,  tools: [T.forms] },
          { id: 'error_handling',   label: 'Error state handling',          default: true,  tools: [T.forms] },
          { id: 'recaptcha',        label: 'reCAPTCHA / bot protection',    default: false, tools: [T.forms] },
        ],
      },
    ],
  },
    ...
    checkboxGroups: [
      {
        group: 'Error Types',
        items: [
          { id: 'js_errors',         label: 'JavaScript runtime errors',     default: true,  tools: [T.console] },
          { id: 'js_warnings',       label: 'JS warnings',                   default: true,  tools: [T.console] },
          { id: 'network_errors',    label: 'Network / Fetch failures',      default: true,  tools: [T.console] },
          ...
          { id: 'unhandled_promises',label: 'Unhandled promise rejections',  default: false, tools: [T.console] },
        ],
      },
      {
        group: 'Resource Checks',
        items: [
          { id: 'missing_assets', label: 'Missing images / assets (404)',  default: true,  tools: [T.console, T.links] },
          { id: 'js_404',         label: 'Failed script / CSS file loads',  default: false, tools: [T.console] },
          { id: 'font_errors',    label: 'Web font load failures',          default: false, tools: [T.console] },
          { id: 'slow_resources', label: 'Slow loading resources (>3s)',    default: false, tools: [T.console, T.vitals] },
          { id: 'ssl_errors',     label: 'SSL / Mixed content errors',      default: true,  tools: [T.console] },
          { id: 'csp_violations', label: 'CSP policy violations',           default: false, tools: [T.console] },
        ],
      },
    ],
  },
    ...
    checkboxGroups: [
      {
        ...
        items: [
          { id: 'lcp',            label: 'LCP — Largest Contentful Paint', default: true,  tools: [T.vitals, T.psi] },
          ...
          { id: 'fcp',            label: 'FCP — First Contentful Paint',    default: true,  tools: [T.vitals, T.psi] },
          ...
          { id: 'render_blocking',label: 'Render-blocking resources',       default: false, tools: [T.psi] },
        ],
      },
      {
        group: 'HTML Markup Quality',
        items: [
          { id: 'semantic_html',     label: 'Semantic HTML5 structure',    default: true,  tools: [T.meta] },
          ...
          { id: 'heading_hierarchy', label: 'Heading hierarchy (H1–H6)',   default: true,  tools: [T.meta, T.a11y] },
          { id: 'alt_attributes',    label: 'Image alt attributes',        default: true,  tools: [T.a11y] },
          { id: 'aria_labels',       label: 'ARIA labels & accessibility', default: false, tools: [T.a11y] },
          { id: 'lang_attr',         label: 'HTML lang attribute',         default: false, tools: [T.a11y] },
          { id: 'schema_markup',     label: 'Schema / Structured data',    default: false, tools: [T.meta] },
...
export function mergeCustomChecks(mod, customItems, disabledIds = []) {
  ...
  const groups = mod.checkboxGroups.map(g => ({ ...g, items: g.items.filter(i => !disabled.has(i.id)) }))
  ...
  for (const it of (customItems || [])) {
    ...
    let g = byName[name]
    if (!g) { g = { group: name, items: [] }; groups.push(g); byName[name] = g }
...
export function buildCheckState(mod, allOn = false) {
  const state = {}
  mod.checkboxGroups.forEach(g => g.items.forEach(i => {
...
export function selectedCheckLabels(mod, checkState) {
  ...
  mod.checkboxGroups.forEach(g => g.items.forEach(i => {
    ...
    if (isDropdown(i)) { if (v) labels.push(`${i.label}: ${v}`) }
